...
def index_file(file, index_name):
    ...
    for child in children:
        ...
        docs.append(_doc)
        if len(docs) == 2000:
            bulk(client, docs, request_timeout=60) #TODO: test different values apart from 60
            docs_indexed += len(docs) # increase the count of indexed docs
            docs = [] # reset docs for new batch
